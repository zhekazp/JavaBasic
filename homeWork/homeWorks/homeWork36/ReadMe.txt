...
Task2-8
Write a method that receives a HashSet and a conversion function,
and returns a HashSet with all values converted using conversion functions
if HashSet is not empty. If HashSet is empty, the method returns an empty HashSet.
